...
def isochrone_mapping_intersection(  # FIXME: Check intersections of inexistent isochrones.
    gdf_point: gpd.GeoDataFrame,
    travel_times: list = [5, 10, 15],
    speed: float = 4.5,
    network_type: Literal["walk", "drive", "bike"] = "walk",
    ...
    for i in gdf_point.amenity.unique():
        element_amenities_df = gdf_point[gdf_point.amenity == i]
